...
<table width="100%" border="0" class="table table-hover" >
	<tr>
		<td>
			<div class="btn-group" data-toggle="buttons-checkbox">
				<button type="button" class="btn btn-primary" onClick="window.location='nuevo_proveedor.php'"> Nuevo Proveedor</button>	
			</div>
		</td>
								...
								<datalist id="characters">
									<?php
										...
										while($aux =  mysqli_fetch_array($result)){
											echo '<option value="'.$aux['Prov_Nombre'].'">';
	...
	<tr class="info">	<td colspan="3">	<center> <strong>LISTADO DE PROVEEDORES</strong></center>	</td>	</tr>
...
<div align="center">
	<table  width="80%" border="0"class="table table-striped table-bordered  table-hover">
		...
		<tr>
			...
			<th width="11%"><strong>Contacto</strong></th>
		...
		<?php 
			...
			$sql =  "SELECT * FROM proveedor ORDER BY Prov_Nombre LIMIT $reg_Empezar,$Mostar";
			}else{
			$buscar = $_POST['buscar'];			
			$sql =  "SELECT * FROM proveedor WHERE Prov_Nombre LIKE '%$buscar%' ORDER BY Prov_Nombre LIMIT $reg_Empezar,$Mostar ";			
			}
			$result = mysqli_query($conexion,$sql);
		...
		<tr>
			...
			<td width="14%"><?php echo $aux['Prov_Nombre'] ?></td>
			<td width="9%"><?php echo $aux['Prov_NIT'] ?></td>
			<td width="11%"><?php echo $aux['Prov_Direccion'] ?></td>
			<td width="11%"><?php  echo $aux['Prov_Contacto']   ?></td>
			<td width="10%"><?php  echo $aux['Prov_Celular']   ?></td>
			<td width="11%"><?php  echo $aux['Prov_Telefono']   ?></td>
			<td width="11%"><?php  echo $aux['Prov_Corre']   ?></td>
			
			<td width="10%"><a href="estado_proveedor.php?estado=<?php echo $aux['idProveedor'] ?>" ><?php echo $estado; ?></a></td>			
			<td width="10%"><a href="modificar_proveedor.php?modificar=<?php echo $aux['idProveedor']?>" > <img src="../img/editar.png" width="15" height="15"> Editar</a></td>		
